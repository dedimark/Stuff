...
//CVARS
ConVar g_cvarRadius = null;
ConVar g_cvarPower = null;
ConVar g_cvarDuration = null;
ConVar g_cvarRainDur = null;
ConVar g_cvarRainRadius = null;
ConVar g_cvarLog = null;
...
public void OnPluginStart()
{
	...
	if (LibraryExists("adminmenu") && ((g_hTopMenu = GetAdminTopMenu()) != null))
	{
...
//**********************************EVENTS*******************************************
public void OnVehicleReady(Event event, const char[] name, bool dontBroadcast)
{
...
/*public MenuItem_WipeBody(TopMenu topmenu, TopMenuAction action, TopMenuObject:object_id, param, char buffer[], maxlength)
{
	if (action == TopMenuAction_DisplayOption)
	{
...
stock void EmitAmbientGenericSound(float pos[3], const char[] snd_str)
{
