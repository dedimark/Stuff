...
public void AdminMenu_AllowJoinMsg(TopMenu topmenu, TopMenuAction action, TopMenuObject object_id, int param, char[] buffer, int maxlength)
{
...
{
	Menu menu = CreateMenu(MenuHandler_AllowJoinMsg);
