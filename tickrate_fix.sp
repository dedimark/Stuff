...
public void OnPluginStart()
{
	...
	g_hPistolDelayDualies = CreateConVar("l4d_pistol_delay_dualies", "0.1", "Minimum time (in seconds) between dual pistol shots", CVAR_FLAGS, true, 0.0, true, 5.0);
	g_hPistolDelaySingle = CreateConVar("l4d_pistol_delay_single", "0.2", "Minimum time (in seconds) between single pistol shots", CVAR_FLAGS, true, 0.0, true, 5.0);
	g_hPistolDelayIncapped = CreateConVar("l4d_pistol_delay_incapped", "0.3", "Minimum time (in seconds) between pistol shots while incapped", CVAR_FLAGS, true, 0.0, true, 5.0);
	g_hCvarDoorSpeed = CreateConVar("l4d_tick_door_speed", "2.0", "Sets the speed of all prop_door entities on a map. 1.05 means = 105% speed", CVAR_FLAGS, true, 0.0, true, 5.0);
