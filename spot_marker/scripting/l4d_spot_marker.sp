...
1.0.8 (28-November-2022)
    - Fixed precache overflow.
...
#define PLUGIN_AUTHOR                 "Mart, Dosergen"
...
bool g_bCvar_Alive;
bool g_bCvar_Field;
bool g_bCvar_FieldModel;
bool g_bCvar_RandomFieldColor;
bool g_bCvar_Sprite;
bool g_bCvar_SpriteModel;
...
public void OnPluginStart()
{
    ...
    g_hCvar_SpriteModel        = CreateConVar("l4d_spot_marker_sprite_model", "materials/vgui/icon_arrow_down.vmt", "Sprite model.");
...
void GetCvars()
{
    ...
    if (g_bCvar_SkillReadySound && g_bMapStarted)
        PrecacheSound(g_sCvar_SkillReadySound, true);
    ...
    if (g_bCvar_UseSound && g_bMapStarted)
        PrecacheSound(g_sCvar_UseSound, true);
    ...
    g_bCvar_FieldModel = (g_sCvar_FieldModel[0] != 0);
    if (g_bCvar_FieldModel && g_bMapStarted)
        g_iFieldModelIndex = PrecacheModel(g_sCvar_FieldModel, true);
    ...
    g_bCvar_SpriteModel = (g_sCvar_SpriteModel[0] != 0);
    if (g_bCvar_SpriteModel && g_bMapStarted)
        PrecacheModel(g_sCvar_SpriteModel, true);
